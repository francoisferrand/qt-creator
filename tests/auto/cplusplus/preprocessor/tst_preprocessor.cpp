...
void tst_Preprocessor::trigraph()
{
    ...
    //We cannot use actual trigraphs in strings, they would be replaced by the preprocessor when compiling the test,
    //so we use strings with 'j' character instead of '?', and perform a replacement at runtime.
